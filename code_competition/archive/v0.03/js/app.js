...
function loadProblem(problem) {
  ...
  `).join('');
  // Generate randomized test cases for actual execution
...
async function runCode() {
  ...
  setTimeout(() => {
    try {
      ...
      // functional tests (use generated/randomized cases when available)
      const testCases = state.generatedCases[state.currentProblem.id] || state.currentProblem.testCases || [];
